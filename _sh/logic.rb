...
my_folders = %w(accounting angularjs datastructures-algorithms clojure css docker elixir erlang golang golang-devops golang-testing graphdb hetzner lua-useful mongodb meteorjs nginx-lua nosql puppet ruby startup).map{|x| "#{x}-stuff"}
