...
my_folders = %w(accounting angularjs datastructures-algorithms clojure css docker elixir erlang golang graphdb hetzner lua-useful mongodb meteorjs nginx-lua nosql puppet rubyi startup).map{|x| "#{x}-stuff"}
